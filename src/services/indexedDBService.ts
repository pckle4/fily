    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        fileRequest.onerror = (event) => {
          console.error('File storage failed:', event);
        ...
        fileRequest.onsuccess = () => {
          ...
          metadataRequest.onerror = (event) => {
            console.error('Metadata storage failed:', event);
  ...
  async getFileByShareId(shareId: string): Promise<{ metadata: FileMetadata; file: File } | null> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        metadataRequest.onerror = (event) => {
          console.error('Metadata fetch failed:', event);
          reject(new Error('Failed to fetch file metadata'));
        };
        
        metadataRequest.onsuccess = (event) => {
          const metadata = (event.target as IDBRequest).result as FileMetadata | undefined;
          ...
          fileRequest.onerror = (event) => {
            console.error('File fetch failed:', event);
  ...
  async deleteFile(id: string): Promise<void> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        fileRequest.onerror = (event) => {
          console.error('File deletion failed:', event);
        ...
        fileRequest.onsuccess = () => {
          ...
          metadataRequest.onerror = (event) => {
            console.error('Metadata deletion failed:', event);
  ...
  async cleanupExpiredFiles(): Promise<void> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          console.error('Expired files fetch failed:', event);
